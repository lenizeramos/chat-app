...
$(() => {
    ...
    $searchGroupUsers.on("input", function () {
        var _a;
        const searchTerm = ((_a = $(this).val()) === null || _a === void 0 ? void 0 : _a.toString().toLowerCase()) || "";
    ...
    $createGroupForm.on("submit", function (e) {
        var _a;
        e.preventDefault();
        const groupName = (_a = $("#groupName").val()) === null || _a === void 0 ? void 0 : _a.toString().trim();
        if (!groupName) {
    ...
    $searchInput.on("input", function () {
        ...
        selectedUserId = null;
        const searchTerm = ((_a = $(this).val()) === null || _a === void 0 ? void 0 : _a.toString().trim()) || "";
        if (searchTerm === "") {
    ...
    $(".attach-file").on("change", (e) => __awaiter(void 0, void 0, void 0, function* () {
        var _a;
        ...
        if (file) {
            ...
            try {
                const response = yield fetch("/chat/upload", {
                    method: "POST",
                    body: formData,
                });
                if (response.ok) {
                    const { fileUrl } = yield response.json();
                    socket.emit("message", {
                        room: currentRoom,
                        message: "",
                        fileUrl,
    ...
    socket.on("message", ({ username, message, fileUrl, }) => {
        displayMessage(username, message, fileUrl);
    });
    const displayMessage = (username, message, fileUrl) => {
